<?php
	...
	if (!function_exists('mypage_edit')) {
		function mypage_edit()
		{
			...
			if($etc == "승진리셋"){
				$sql3 = "UPDATE tb_evaluation SET score = '0', etc = '$etc' WHERE user_id = '$user_id'";
				$user_promote = mysqli_query($db_link, $sql3);

				$sql4 = "UPDATE eval_user SET user_rank ='$user_rank'
								WHERE user_id = '$user_id'";
				$user_promote2 = mysqli_query($db_link, $sql4);
			}
