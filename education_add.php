		...
		<div class = "body_table">
			<table class = "tbl_score" id = "edu_table">
				<tr>
					...
					<td>
						<span class = "re_td2" style = "margin-left:0px;">
							<label for = "et1" style = "margin-bottom:-5px;"><input type = "radio" id = "et1" name = "edu_type" value = "3"/> <span style = "line-height:3;margin-right:20px;">전사</span></label>
							<label for = "et2" style = "margin-bottom:-5px;"><input type = "radio" id = "et2" name = "edu_type" value = "0"/> <span style = "line-height:3;margin-right:20px;">임원</span>
							<label for = "et3" style = "margin-bottom:-5px;"><input type = "radio" id = "et3" name = "edu_type" value = "1"/> <span style = "line-height:3;margin-right:20px;">팀장</span>
							<label for = "et4" style = "margin-bottom:-5px;"><input type = "radio" id = "et4" name = "edu_type" value = "2"/> <span style = "line-height:3;margin-right:20px;">개별</span>
						</span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type = "text" name = "edu_name" class = "input_title">
				...
				<tr>
					...
					<td>
						<input type = "text" name = "edu_period" class = "input_title">
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type = "text" name = "edu_startdate" id = "edu_startdate"> 
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type = "text" name = "edu_enddate" id = "edu_enddate"> 
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type = "text" name = "edu_time" class = "input_title">
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<input type = "text" name = "edu_institution" class = "input_title">
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<span class = "re_td2" style = "margin-left:0px;">
							<label for = "fileyn" style = "margin-bottom:-5px;"><input type = "checkbox" id = "fileyn" name = "edu_file_yn" value = "1" /> <span style = "line-height:3;margin-right:20px;">필수</span></label>
						</span>
					</td>
				</tr>
				<?
				...
				?>
				<tr id = "selectpep" style = "display:none;">
					<th>
...
<script>
	...
	function goSubmit() {
		...
		if($('#chkveg').val() == ''){ //개별교육 아닌경우
			var fnc = "education_add_all";
			$.ajax({
				type: 'POST',
...
<style>
	...
	.listbtn, #btnget,.btn-group {background-color:#214796; height:40px; color:white; border:none; border-radius:8px; padding-right:20px; padding-left:20px;font-size:16px; font-weight:600;}
